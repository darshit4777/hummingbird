...
public:
    ...
    Eigen::Quaterniond m_errorQuaternion;           // The rotation error matrix expressed as a quaternion
    Eigen::Vector3d m_angularVelocityDesired;       // The desired angular velocity calculated as a derivative of desired rotation
    // Controller Outputs    
    ...
    Eigen::Vector3d m_torqueVector;                 // Torque outputs generated by controller
...
Eigen::Quaterniond GetErrorQuaternion();
